...
public class Find {
    ...
    public void findsymptom()throws UnrecognizedDiseaseException{
        ...
        try {
            FileInputStream fstream = new FileInputStream("../Medical-Assistant/txt/symptoms.txt");
    ...
    public void findDisease() throws UnrecognizedDiseaseException {
        ...
        Properties prop=new Properties();
        try {
            FileInputStream fstream = new FileInputStream("../Medical-Assistant/txt/disease.txt");
            // Get the object of DataInputStream
            DataInputStream in = new DataInputStream(fstream);
            BufferedReader br = new BufferedReader(new InputStreamReader(in));
            String strLine;
